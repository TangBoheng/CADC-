...
void threat_classifier(char *datacfg, char *cfgfile, char *weightfile, int cam_index, const char *filename, const CvArr *mapx, const CvArr *mapy)
{
#ifdef OPENCV
    float threat = 0;
    float roll = .2;
    ...
    while(1){
        ...
        image in = get_image_from_stream_cpp(cap, mapx, mapy);
        if(!in.data) break;
...
void gun_classifier(char *datacfg, char *cfgfile, char *weightfile, int cam_index, const char *filename, const CvArr *mapx, const CvArr *mapy)
{
#ifdef OPENCV
...
void demo_classifier(char *datacfg, char *cfgfile, char *weightfile, int cam_index, const char *filename, const CvArr *mapx, const CvArr *mapy)
{
#ifdef OPENCV
    printf("Classifier Demo\n");
    network net = parse_network_cfg_custom(cfgfile, 1);
...
void run_classifier(int argc, char **argv, const CvArr *mapx, const CvArr *mapy)
{
    if(argc < 4){
    ...
    else if(0==strcmp(argv[2], "demo")) demo_classifier(data, cfg, weights, cam_index, filename, mapx, mapy);
    else if(0==strcmp(argv[2], "gun")) gun_classifier(data, cfg, weights, cam_index, filename, mapx, mapy);
    else if(0==strcmp(argv[2], "threat")) threat_classifier(data, cfg, weights, cam_index, filename, mapx, mapy);
